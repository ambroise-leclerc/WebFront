...
public:
    ...
    static MutableBuffer Buffer(void* d, std::size_t s) noexcept {
        return {d, s};
    }
    static ConstBuffer Buffer(const void* d, std::size_t s) noexcept {
        return {d, s};
    }
    static MutableBuffer Buffer(const MutableBuffer& b) noexcept {
        return b;
    }
    static MutableBuffer Buffer(const MutableBuffer& b, std::size_t s) noexcept {
        return {b.data(), std::min(b.size(), s)};
    }
    static ConstBuffer Buffer(const ConstBuffer& b) noexcept {
        return b;
    }
    static ConstBuffer Buffer(const ConstBuffer& b, std::size_t s) noexcept {
        return {b.data(), std::min(b.size(), s)};
    }
