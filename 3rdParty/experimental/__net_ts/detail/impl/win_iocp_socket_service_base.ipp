...
#ifndef NET_TS_DETAIL_IMPL_WIN_IOCP_SOCKET_SERVICE_BASE_IPP
#define NET_TS_DETAIL_IMPL_WIN_IOCP_SOCKET_SERVICE_BASE_IPP
...
#if defined(NET_TS_ENABLE_CANCELIO)
    ...
    std::error_code& ec)
{
  if (is_open(impl))
  {
    NET_TS_HANDLER_OPERATION((iocp_service_.context(),
...
{
#if defined(NET_TS_DISABLE_CONNECTEX)
  (void)impl;
  (void)type;
  return 0;
#else // defined(NET_TS_DISABLE_CONNECTEX)
...
#endif // NET_TS_DETAIL_IMPL_WIN_IOCP_SOCKET_SERVICE_BASE_IPP
