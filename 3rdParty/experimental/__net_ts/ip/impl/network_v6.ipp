...
#ifndef NET_TS_IP_IMPL_NETWORK_V6_IPP
#define NET_TS_IP_IMPL_NETWORK_V6_IPP
...
NET_TS_DECL address_v6 network_v6::network() const NET_TS_NOEXCEPT
{
...
address_v6_range network_v6::hosts() const NET_TS_NOEXCEPT
{
...
std::string network_v6::to_string(std::error_code& ec) const
{
  ...
  sprintf(prefix_len, 16, "/%u", prefix_length_);
...
#endif // NET_TS_IP_IMPL_NETWORK_V6_IPP
